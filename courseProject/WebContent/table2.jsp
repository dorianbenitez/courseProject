...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center position-sticky">
    <li class="page-item">
      <a class="page-link" href="table.jsp">Previous</a>
    </li>
    <li class="page-item"><a class="page-link" href="table.jsp">1</a></li>
    <li class="page-item disabled"><a class="page-link" href="table2.jsp">2</a></li>
    <li class="page-item"><a class="page-link" href="table3.jsp">3</a></li>
    <li class="page-item">
      <a class="page-link" href="table3.jsp">Next</a>
    </li>
  </ul>
</nav>
